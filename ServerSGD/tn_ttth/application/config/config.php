...
// smtp username
$config['smtp_username'] = "ttthnhanhnt@gmail.com";
// smtp password
$config['smtp_password'] = "thanhnhan1";
...
$config['activation_subject'] = "Kích hoạt tài khoản - TTTH";
// activation email message
$config['activation_message'] = "Chào, \r\n Cảm ơn bạn đã đăng ký. Vui lòng chọn link để xác thực.\r\n [verilink] \r\n or \r\n Copy link và dán vào trình duyệt \r\n [verilink] \r\n \r\n Cảm ơn";


// password reset email subject
$config['password_subject'] = "Password đã thay đổi";
// password reset email message
$config['passsword_message'] = "Hi, \r\n Password mới là: [new_password] \r\n Cảm ơn";
...
$config['result_message'] = "Chào [last_name],\r\n \r\n  Bạn đã [result_status] bài kiểm tra: '[quiz_name]' và số câu đúng là: [score_obtained]. Vui lòng truy cập website http://222.255.128.112:81/tn_ttth/ để xem chi tiết.\r\n  \r\n  Cảm ơn \r\n P/S: Phần mềm ôn tập trắc nghiệm trên Android : http://ttth.thuathienhue.edu.vn/tin-tuc/ung-dung-cntt/on-luyen-trac-nghiem-tren-android-voi-quizit.htm ";
// result email subject
$config['result_subject'] = "Kết quả của bài Quiz [quiz_name]";




// email send from
$config['fromemail']="ttthnhanhnt@gmail.com";
// from name
$config['fromname']="Administrator - TTTH";
